...
import kotlinx.android.synthetic.main.fragment_gl_camera.*
import java.io.File
 ...
 * @date 2020/4/16
 */
class CameraGLFragment : Fragment(), SurfaceHolder.Callback {
    companion object {


        fun newInstance() = CameraGLFragment()
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_gl_camera, container, false)
    }
